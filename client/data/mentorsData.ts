...
export const mentorsData: Mentor[] = [
  ...
  },
  {
    ...
    img: "https://cdn.builder.io/api/v1/image/assets%2F728d0307159d4db0b6c1744ba0b9e3d6%2F8f8e8e8e8e8e8e8e8e8e8e8e8e8e8e8e?format=webp&width=400",
    aboutMe:
      "With a decade of experience at Emirates, I am an expert in premium airline services and international protocols. I have trained and mentored hundreds of cabin crew candidates and currently work on training programs for Emirates. My sessions are designed to provide real insights into what makes a successful cabin crew member in the luxury aviation sector.",
    userReviews: [
      {
        id: 1,
        reviewer: "Anjali V.",
  ...
  },
  {
    ...
    img: "https://cdn.builder.io/api/v1/image/assets%2F728d0307159d4db0b6c1744ba0b9e3d6%2F8f8e8e8e8e8e8e8e8e8e8e8e8e8e8e8e?format=webp&width=400",
    aboutMe:
      "As a Cabin Crew member at IndiGo, I focus on helping entry-level candidates kickstart their aviation career. My background in service excellence and customer interaction helps guide aspiring cabin crew members through the entire selection process. I love mentoring young talents and helping them achieve their dreams.",
    userReviews: [
      {
        id: 1,
        reviewer: "Tushar M.",
  ...
  },
  {
    ...
    img: "https://cdn.builder.io/api/v1/image/assets%2F728d0307159d4db0b6c1744ba0b9e3d6%2F8f8e8e8e8e8e8e8e8e8e8e8e8e8e8e8e?format=webp&width=400",
    aboutMe:
      "With 6 years of experience flying with Lufthansa, I specialize in European airline standards and customer relations. I understand the German work culture and customer service expectations of premium European carriers. My mentoring helps candidates understand and adapt to European aviation standards.",
    userReviews: [
      {
        id: 1,
        reviewer: "Isha D.",
  ...
  },
  {
    ...
    img: "https://cdn.builder.io/api/v1/image/assets%2F728d0307159d4db0b6c1744ba0b9e3d6%2F8f8e8e8e8e8e8e8e8e8e8e8e8e8e8e8e?format=webp&width=400",
    aboutMe:
      "With 7 years at Thai Airways, I bring expertise in Asian markets and cultural sensitivity. I help candidates understand Asian hospitality standards and the unique requirements of regional carriers. My mentoring emphasizes cultural awareness and regional customer service excellence.",
    userReviews: [
      {
        id: 1,
        reviewer: "Leena V.",
